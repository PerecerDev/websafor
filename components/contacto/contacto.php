...
<section id="contacto" data-theme="white" class="bg-white text-black px-10 py-16 lg:!py-32 text-center">
    <div class="container mx-auto w-full lg:!w-3/4">
        <h2 class="text-5xl font-bold font-serif mb-10">¡Tu negocio al siguiente nivel!</h2>
        <p class="text-xl font-thin mb-10">Llámanos o envíanos un WhatsApp al <span class="font-semibold">644 286 244</span> o escríbenos a <a href="mailto:info@websafor.com" class="underline font-semibold">info@websafor.com</a>.</p>

        <div class="mt-6 lg:flex justify-center space-x-4">
            <a id="emailButton" href="tel:+34644286244" class="flex items-center justify-center mb-4 lg:gap-4 flex-grow-0 flex-shrink-0 px-6 py-4 bg-gray-300 hover:bg-gray-400 text-teal-900 rounded-lg shadow-md transition duration-200 ease-in-out w-full lg:w-auto">
            ...
            <a id="whatsappButton" href="https://api.whatsapp.com/send?phone=+34644286244" class="flex items-center justify-center lg:gap-4 flex-grow-0 flex-shrink-0 px-6 py-4 bg-green-600 hover:bg-green-700 text-white rounded-lg shadow-md transition duration-200 ease-in-out w-full lg:w-auto">
        ...
        <div class="border-t border-gray-300 mt-10 pt-10">
            <p class="text-xl font-thin mb-6">O si lo prefieres, puedes rellenar este formulario y te contactaremos nosotros</p>
