...
<section id="contacto" data-theme="white" class="bg-white text-black px-10 py-16 lg:!py-32 text-center">
    <div class="container mx-auto w-full lg:!w-3/4">
        ...
        <div class="mt-6 lg:flex justify-center space-x-4">
            <a id="emailButton" href="tel:+34644286244" class="flex items-center justify-center gap-4 flex-grow-0 flex-shrink-0 px-6 py-4 bg-gray-300 hover:bg-gray-400 text-teal-900 rounded-lg shadow-md transition duration-200 ease-in-out w-full lg:w-auto">
