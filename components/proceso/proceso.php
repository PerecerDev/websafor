...
<section id="proceso" data-theme="orange" class="bg-orange-200 text-teal-900 px-10 py-16 lg:!py-32 body-font font-sans">
    <div class="container mx-auto w-full lg:!w-3/4">
        <div class="mx-auto text-center mb-8 lg:mb-12">
            <h2 class="mb-4 lg:!mb-10 text-5xl lg:!text-6xl font-bold font-serif text-teal-950 ">Proceso para tener tu Página Web</h2>
        </div>    
        ...
        <div class="flex relative pt-10 pb-20 sm:items-center md:w-2/3 mx-auto text-center">
            ...
            <div class="flex flex-col items-center">
                ...
                <p class="leading-relaxed text-center">Descripción detallada del acuerdo de web, incluyendo los términos y condiciones, expectativas y otros detalles relevantes.</p>
            </div>
        </div>
        ...
        <div class="flex relative pt-10 pb-20 sm:items-center md:w-2/3 mx-auto text-center">
            ...
            <div class="flex flex-col items-center">
                ...
                <p class="leading-relaxed text-center">Descripción detallada de la firma del contrato, incluyendo los términos específicos, fechas clave y otros aspectos importantes del acuerdo.</p>
            </div>
        </div>
        ...
        <div class="flex relative pt-10 pb-20 sm:items-center md:w-2/3 mx-auto text-center">
            ...
            <div class="flex flex-col items-center">
                ...
                <p class="leading-relaxed text-center">Descripción detallada del proceso de depósito. Esto incluirá cómo se debe realizar el pago, las fechas límite y cualquier otro detalle relevante.</p>
            </div>
        </div>
        ...
        <div class="flex relative pt-10 pb-20 sm:items-center md:w-2/3 mx-auto text-center">
            ...
            <div class="flex flex-col items-center">
                ...
                <p class="leading-relaxed text-center">Descripción detallada del proceso de desarrollo. Esto incluirá las etapas clave, las revisiones, las comunicaciones con el cliente y cualquier otro aspecto importante del desarrollo.</p>
            </div>
        </div>
        <!-- Paso 5: Restante 50% -->
        <div class="flex relative pt-10 pb-20 sm:items-center md:w-2/3 mx-auto text-center">
            ...
            <div class="flex flex-col items-center">
                ...
                <p class="leading-relaxed text-center">Descripción detallada del proceso de pago del saldo restante. Esto incluirá cómo se debe realizar el pago, las fechas límite y cualquier otro detalle relevante.</p>
            </div>
        </div>
        ...
        <div class="flex relative pt-10 pb-20 sm:items-center md:w-2/3 mx-auto text-center">
            ...
            <div class="flex flex-col items-center">
                ...
                <p class="leading-relaxed text-center">Descripción detallada del proceso de entrega del proyecto. Esto incluirá cómo se entregará el proyecto, las revisiones finales, la formación del cliente y cualquier otro aspecto importante de la entrega.</p>
            </div>
        </div>
    ...
    <!-- Paso 2: Firma de contrato -->
    <!-- ... (El código sigue el mismo patrón que el Paso 1) ... -->
