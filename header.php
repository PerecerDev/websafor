...
<html lang="es" class="scroll-smooth">
	<head>
		...
		<!-- Google tag (gtag.js) -->
		<script async src="https://www.googletagmanager.com/gtag/js?id=AW-11385693493"></script>
		<script>
		window.dataLayer = window.dataLayer || [];
		function gtag(){dataLayer.push(arguments);}
		gtag('js', new Date());

		gtag('config', 'AW-11385693493');
		</script>
		...
		<meta name="msapplication-TileColor" content="#0c4847">
		<meta name="theme-color" content="#0c4847">
	</head>
